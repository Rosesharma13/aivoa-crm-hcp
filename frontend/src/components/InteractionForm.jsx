  ...
  return (
    <div style={s.grid}>
      ...
      <div>
        ...
        {submitStatus === 'error' && (
          <div style={{ background: '#fce8e6', border: '1px solid #f6aea9', borderRadius: '10px', padding: '16px', marginBottom: '16px' }}>
            <div style={{ fontWeight: '600', color: '#c5221f' }}>Could not log interaction</div>
            <div style={{ fontSize: '13px', color: '#c5221f' }}>{submitError}</div>
          </div>
        )}
